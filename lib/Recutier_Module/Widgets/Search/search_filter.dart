...
import 'package:true_jobs/Recutier_Module/Widgets/Search/rec_search_display.dart';
      ...
      case 4: // Salary
        return Column(
          ...
          children: [
            ...
            _radio(
              "Hour",
              selected: selectedSalaryType == "Hour",
              onTap: () => setState(() => selectedSalaryType = "Hour"),
            ),
            _radio(
              "Day",
              selected: selectedSalaryType == "Day",
              onTap: () => setState(() => selectedSalaryType = "Day"),
            ),
            _radio(
              "Week",
              selected: selectedSalaryType == "Week",
              onTap: () => setState(() => selectedSalaryType = "Week"),
            ),
            _radio(
              "Month",
              selected: selectedSalaryType == "Month",
              onTap: () => setState(() => selectedSalaryType = "Month"),
            ),
            const SizedBox(height: 16),
      ...
      case 7: // Last Active
        return Column(
          ...
          children: [
            ...
            _radio(
              "7 days",
              selected: selectedLastActive == "7 days",
              onTap: () => setState(() => selectedLastActive = "7 days"),
            ),
            _radio(
              "15 days",
              selected: selectedLastActive == "15 days",
              onTap: () => setState(() => selectedLastActive = "15 days"),
            ),
            _radio(
              "1 month",
              selected: selectedLastActive == "1 month",
              onTap: () => setState(() => selectedLastActive = "1 month"),
            ),
            _radio(
              "2 months",
              selected: selectedLastActive == "2 months",
              onTap: () => setState(() => selectedLastActive = "2 months"),
            ),
            _radio(
              "5 months",
              selected: selectedLastActive == "5 months",
              onTap: () => setState(() => selectedLastActive = "5 months"),
            ),
          ],
        );
