...
import 'package:true_jobs/JOB_RECRUITER/Rec_payment_screens/payment_success.dart';
...
class _PaymentState extends State<Payment> {
  ...
  Widget build(BuildContext context) {
    ...
    final headerFontSize = isTablet ? 22.0 : 18.0;
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Radio<String>(
              value: value,
              groupValue: selectedOtherMode,
              onChanged: (String? newValue) {
                setState(() {
                  selectedOtherMode = newValue ?? '';
                  selectedPaymentMode = '';
                });
              },
              activeColor: const Color(0xFF7C329B),
            ),
