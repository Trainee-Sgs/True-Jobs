...
import 'package:true_jobs/JOB_RECRUITER/Rec_Chate_Screen/rec_chat.dart';
...
class _RecHomeState extends State<RecHome> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _buildBottomNav(context, screenWidth, screenHeight),
    );
  }
